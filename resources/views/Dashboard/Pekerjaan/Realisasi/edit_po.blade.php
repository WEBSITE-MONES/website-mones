            ...
            <form action="{{ route('realisasi.updatePO', $po->id) }}" method="POST">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="nilai_po" id="nilai_po" class="form-control"
                                value="{{ old('nilai_po', number_format($po->nilai_po, 0, ',', '.')) }}" required>
                        </div>
                    </div>
                ...
                <table class="table table-bordered" id="termin-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><input type="text" name="termins[{{ $i }}][uraian]" value="{{ $termin->uraian }}"
                                    class="form-control inp-uraian"></td>
                            <td><input type="number" name="termins[{{ $i }}][persentase]"
                                    value="{{ $termin->persentase }}" class="form-control inp-persen"></td>
                            <td><input type="text" name="termins[{{ $i }}][syarat_pembayaran]"
                                    value="{{ $termin->syarat_pembayaran }}" class="form-control inp-syarat"></td>
                            <td><input type="text" class="form-control nilai-pembayaran"
                                    value="{{ number_format($termin->nilai_pembayaran, 0, ',', '.') }}" readonly></td>
                ...
                <div class="text-end mt-4">
                    ...
                    <button type="submit" id="btnSimpanPO" class="btn btn-primary">Update PO</button>
                </div>
            </form>
        </div>
    </div>
